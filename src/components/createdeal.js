...
import contract from "../../artifacts/contracts/DaoDealClient.sol/DaoDealClient.json";
//../artifacts/contracts/DaoDealClient.sol/DaoDealClient.json
...
const contractAddress = "0x465ec9468303A06045De28C96B931ad336E70fe6";
  ...
  */
  ...
  const connectWalletButton = () => {
    return (
      ...
      { network && <div style={{ color: "green" }}> Network: Filecoin Callibration </div>}
      </div></div>
    );
  };
